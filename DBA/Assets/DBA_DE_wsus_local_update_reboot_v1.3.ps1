...
{ #Write-Log "Reboot is not pending for $computer" }

else { #Write-Log "Reboot is pending for $computer" Exit } #>
...
<#function Write-Log {
    ...
    Write-Log "$(get-date -UFormat '%Y/%m/%d-%H:%M:%S')#$($level)# $message" -ForegroundColor $MsgColors[$level]
}#>
...
Clear-Host
#Write-Log "========== Entering CheckMK Maintenance Mode   ============="
...
Start-Sleep -Seconds 30
 ...
 #Write-Log "================ Shutting down Solid 1414 ================"
