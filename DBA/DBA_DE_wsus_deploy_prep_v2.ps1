...
$sourcePath_W1_WSUS_Update_check_xml = "$ScriptDir\DBA_DE_W1_Test_WSUS_Monthly_Update.xml" 	#Scheduled Update Task local xml path
$sourcePath_W2_WSUS_Update_check_xml = "$ScriptDir\DBA_DE_W2_Test_WSUS_Monthly_Update.xml" 	#Scheduled Update Task local xml path
$sourcePath_W3_WSUS_Update_check_xml = "$ScriptDir\DBA_DE_W3_Test_WSUS_Monthly_Update.xml" 	#Scheduled Update Task local xml path
$sourcePath_W4_WSUS_Update_check_xml = "$ScriptDir\DBA_DE_W4_Test_WSUS_Monthly_Update.xml" 	#Scheduled Update Task local xml path
$destPath_WSUS_Update_check_xml = "C:\temp\wsus"                                           	#Scheduled Task Destination 
$sourcePath_DBA_DE_1313_sql = "$ScriptDir\1313.sql" 										#1313 sql sourcepath
$destPath_DBA_DE_1313_sql = "C:\tasks"     													#1313 sql destinationpath
$sourcePath_DBA_DE_1414_sql = "$ScriptDir\1414.sql" 										#1414 sql sourcepath
